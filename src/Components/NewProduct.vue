          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <input type="text" v-model="product.count" class="form-control" placeholder="adet giriniz">
              </div>
              <div class="form-group col-md-6">
                <label>Ürün Fiyatı</label>
                <input type="text" v-model="product.price" class="form-control" placeholder="fiyat giriniz">
              </div>
            </div>
